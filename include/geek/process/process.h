...
public:
    ...
    */
    ...
    std::vector<uint64_t> SearchSigEx(const char* pattern, size_t pattern_size, uint64_t start_address, size_t size, size_t max_match_size = static_cast<size_t>(-1)) const;
