...
bool Wow64::Wow64Operation(HANDLE hProcess)
{
	BOOL source, target;
...
void* Wow64::Wow64Malloc(size_t size)
{
	return HeapAlloc(ms_heap, 0, size);
}

void Wow64::Wow64Free(void* ptr)
{
	if (nullptr != ptr)
		HeapFree(ms_heap, 0, ptr);
}

void Wow64::Wow64ExtInit()
{
	if (ms_heap == NULL) {
...
DWORD64 Wow64::X64Call(DWORD64 func, int argC, ...)
{
#ifdef _WIN64
	return 0;
#else
...
DWORD64 Wow64::GetModuleHandle64(const wchar_t* lpModuleName)
{
	if (!ms_is_wow64)
		return 0;
...
void Wow64::SetLastErrorFromX64Call(DWORD64 status)
{
...
DWORD64 Wow64::GetProcAddress64(DWORD64 hModule, const char* funcName)
{
...
DWORD64 Wow64::VirtualQueryEx64(HANDLE hProcess, DWORD64 lpAddress, MEMORY_BASIC_INFORMATION64* lpBuffer,
	SIZE_T dwLength)
{
...
DWORD64 Wow64::VirtualAllocEx64(HANDLE hProcess, DWORD64 lpAddress, SIZE_T dwSize, DWORD flAllocationType,
	DWORD flProtect)
{
...
BOOL Wow64::VirtualFreeEx64(HANDLE hProcess, DWORD64 lpAddress, SIZE_T dwSize, DWORD dwFreeType)
{
...
BOOL Wow64::VirtualProtectEx64(HANDLE hProcess, DWORD64 lpAddress, SIZE_T dwSize, DWORD flNewProtect,
...
BOOL Wow64::ReadProcessMemory64(HANDLE hProcess, DWORD64 lpBaseAddress, LPVOID lpBuffer, SIZE_T nSize,
...
BOOL Wow64::WriteProcessMemory64(HANDLE hProcess, DWORD64 lpBaseAddress, LPVOID lpBuffer, SIZE_T nSize,
...
BOOL Wow64::GetThreadContext64(HANDLE hThread, _CONTEXT64* lpContext)
{
...
BOOL Wow64::SetThreadContext64(HANDLE hThread, _CONTEXT64* lpContext)
{
...
void Wow64::GetMem64(void* dstMem, DWORD64 srcMem, size_t sz)
{
#ifdef _WIN64
	return;
#else
...
bool Wow64::CmpMem64(const void* dstMem, DWORD64 srcMem, size_t sz)
{
#ifdef _WIN64
	return false;
#else
...
DWORD64 Wow64::GetLdrGetProcedureAddress()
{
